...
def createdb():
    ...
    initial_keys = [
        ...
        ('Car dealership closed section key', 0, 'streets for key4'),
        ('Car dealership directors office room key', 0, 'streets for key4'),
        ('Cargo container mesh door key', 0, 'streets for key4'),
        ('Chekannaya 15 apartment key', 0, 'streets for key4'),
        ('Concordia apartment 8 home cinema key', 0, 'streets for key4'),
        ('Concordia apartment 8 room key', 0, 'streets for key4'),
        ('Concordia apartment 34 room key', 0, 'streets for key4'),
        ('Concordia apartment 63 room key', 0, 'streets for key4'),
        ('Concordia apartment 64 key', 0, 'streets for key4'),
        ('Concordia apartment 64 office room key', 0, 'streets for key4'),
        ('Concordia security room key', 0, 'streets for key4'),
        ('Construction site bunkhouse key', 0, 'streets for key4'),
        ('Financial institution office key', 0, 'streets for key4'),
        ('Financial institution small office key', 0, 'streets for key4'),
        ('Iron gate key', 0, 'streets for key4'),
        ('Negotiation room key', 0, 'streets for key4'),
        ('MVD academy entrance hall guard room key', 0, 'streets for key4'),
        ('Mysterious room marked key', 0, 'streetsfor key4'),
        ('PE teachers office key', 0, 'streets for key4'),
        ('Pinewood hotel room 206 key', 0, 'streets for key4'),
        ('Pinewood hotel room 215 key', 0, 'streetsfor key4'),
        ('Primorsky 46-48 skybridge key', 0, 'streets for key4'),
        ('Primorsky 48 apartment key', 0, 'streets for key4'),
        ('Real estate agency office room key', 0, 'streets for key4'),
        ('Relaxation room key', 0, 'streets for key4'),
        ('Rusted bloody key', 0, 'streets for key4'),
        ('Stair landing key', 0, 'streets for key4'),
        ('Store managers key', 0, 'streets for key4'),
        ('Supply department directors office key', 0, 'streets for key4'),
        ('Tarbank cash register department key', 0, 'streets for key4'),
        ('TerraGroup meeting room key', 0, 'streets for key4'),
        ('TerraGroup security armory key', 0, 'streets for key4'),
        ('X-ray room key', 0, 'streets for key4'),
        ('Zmeisky 3 apartment 8 key', 0, 'streets for key4'),
        ('Zmeisky 5 apartment 20 key', 0, 'streets for key4'),
        ('Keycard with a blue marking', 0, 'labs for key4'),
        ('TerraGroup Labs access keycard', 0, 'labs for key4'),
        ('TerraGroup Labs arsenal storage room key', 0, 'labs for key4'),
        ('TerraGroup Labs keycard (Black)', 0, 'labs for key4'),
        ('TerraGroup Labs keycard (Blue)', 0, 'labs for key4'),
        ('TerraGroup Labs keycard (Green)', 0, 'labs for key4'),
        ('TerraGroup Labs keycard (Red)', 0, 'Its pretty bad, just discard it'),
        ('TerraGroup Labs keycard (Violet)', 0, 'labs for key4'),
        ('TerraGroup Labs keycard (Yellow)', 0, 'labs for key4'),
        ('TerraGroup Labs managers office room key', 0, 'labs for key4'),
        ('TerraGroup Labs weapon testing area key', 0, 'labs for key4'),
        ('RB-AK key', 0, 'reserve'),
        ('RB-AM key', 0, 'reserve for key4'),
        ('RB-AO key', 0, 'reserve for key4'),
        ('RB-BK marked key', 0, 'reserve for key4'),
        ('RB-GN key', 0, 'reservefor key4'),
        ('RB-KORL key', 0, 'reserve for key4'),
        ('RB-KPRL key', 0, 'reserve for key4'),
        ('RB-KSM key', 0, 'reserve for key4'),
        ('RB-MP11 key', 0, 'reserve for key4'),
        ('RB-MP12 key', 0, 'reserve for key4'),
        ('RB-MP13 key', 0, 'reserve for key4'),
        ('RB-MP21 key', 0, 'reserve for key4'),
        ('RB-MP22 key', 0, 'reserve for key4'),
        ('RB-OB key', 0, 'reserve for key4'),
        ('RB-OP key', 0, 'reserve for key4'),
        ('RB-ORB1 key', 0, 'reserve for key4'),
        ('RB-ORB2 key', 0, 'reserve for key4'),
        ('RB-ORB3 key', 0, 'reserve for key4'),
        ('RB-PKPM marked key', 0, 'reserve for key4'),
        ('RB-PSP1 key', 0, 'reserve for key4'),
        ('RB-PSP2 key', 0, 'reserve for key4'),
        ('RB-PSV1 key', 0, 'reserve for key4'),
        ('RB-PSV2 key', 0, 'reserve for key4'),
        ('RB-RH key', 0, 'reserve for key4'),
        ('RB-RLSA key', 0, 'reserve for key4'),
        ('RB-RS key', 0, 'reservefor key4'),
        ('RB-SMP key', 0, 'reserve for key4'),
        ('RB-ST key', 0, 'reserve for key4'),
        ('RB-TB key', 0, 'reserve for key4'),
        ('RB-VO marked key', 0, 'reserve for key4'),
        ('Conference room key', 0, 'here be lighthouse'),
        ('Convenience store storage room key', 0, 'lighthouse for key4'),
        ('Hillside house key', 0, 'lighthouse for key4'),
        ('Leons hideout key', 0, 'lighthouse for key4'),
        ('Merin car trunk key', 0, 'lighthouse for key4'),
        ('Operating room key', 0, 'lighthouse for key4'),
        ('Police truck cabin key', 0, 'lighthouse for key4'),
        ('Radar station commandant room key', 0, 'lighthouse for key4'),
        ('Rogue USEC barrack key', 0, 'lighthouse for key4'),
        ('Rogue USEC stash key', 0, 'lighthouse for key4'),
        ('Rogue USEC workshop key', 0, 'lighthouse for key4'),
        ('Shared bedroom marked key', 0, 'lighthouse for key4'),
        ('USEC cottage first safe key', 0, 'lighthouse for key4'),
        ('USEC cottage room key', 0, 'lighthouse for key4'),
        ('USEC cottage second safe key', 0, 'lighthouse for key4'),
        ('Water treatment plant storage room key', 0, 'lighthouse for key4'),
        ('TerraGroup science office key', 0, 'ground zero'),
        ('Underground parking utility room key', 0, 'ground zero for key4'),
        ('Unity Credit Bank cash register key', 0, 'ground zero for key4'),
        ('Folding car key', 0, 'no where for key4'),
        ('Missam forklift key', 0, 'no where for key4'),
        ('Primorsky Ave apartment key', 0, 'no where for key4'),
        ('RB-PP key', 0, 'no where for key4'),
        ('Store safe key', 0, 'no where for key4'),
        ('VAZ car key', 0, 'no where for key4'),
        ('Weapon safe key', 0, 'no where for key4'),
